...
docker run --rm \
  ...
  --env LOAD_SETUP_TOKEN_BUFFER_SECONDS="${LOAD_SETUP_TOKEN_BUFFER_SECONDS:-}" \
  --env LOAD_RESULT_TRIGGER_LEAD_SECONDS="${LOAD_RESULT_TRIGGER_LEAD_SECONDS:-}" \
  --env LOAD_RESULT_CONFIRM_DELAY_SECONDS="${LOAD_RESULT_CONFIRM_DELAY_SECONDS:-}" \
  --env LOAD_RESULT_SETTLE_TIMEOUT_SECONDS="${LOAD_RESULT_SETTLE_TIMEOUT_SECONDS:-}" \
