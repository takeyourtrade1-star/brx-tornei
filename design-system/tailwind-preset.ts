...
/**
 * Ebartex Design System — Tailwind Preset
 *
 * Token estratti 1:1 da new_frontend_brx/tailwind.config.ts.
 * SOURCE OF TRUTH: il repo principale. Non modificare a mano questi valori;
 * se un token cambia su Ebartex, va riallineato qui (vedi ARCHITECTURE.md §3).
 */
const ebartexPreset: Partial<Config> = {
  darkMode: ['class'],
  theme: {
    extend: {
      screens: {
