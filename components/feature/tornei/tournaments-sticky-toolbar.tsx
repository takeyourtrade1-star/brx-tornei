    ...
    <div className="sticky top-2 z-50 isolate">
      <div
        ...
        className={cn(
          ...
          compact
            ? 'rounded-3xl border border-white/15 bg-header-bg/95 px-4 py-3.5 shadow-xl shadow-black/40 ring-1 ring-inset ring-white/[0.06] sm:px-5'
            : 'rounded-3xl border border-white/[0.08] bg-header-bg/90 px-4 py-4 shadow-xl shadow-black/40 sm:px-5',
        )}
      >
        {mobile ? (
