  ...
  return (
    <main className="mx-auto flex min-h-dvh max-w-md flex-col items-center px-5 pb-10 pt-8">
      <a
        ...
        className="mb-4 inline-flex self-start items-center gap-1.5 rounded-full border border-white/15 bg-white/5 px-3.5 py-2 text-xs font-semibold text-white/80 transition hover:border-white/30 hover:bg-white/10 hover:text-white"
      >
