  ...
  return (
    <div
      className={cn(
        ...
        compact ? 'items-center gap-1.5' : 'gap-3',
      )}
    >
      <div
        className={cn(
      ...
      >
        ...
        <span
          className={cn(
            ...
            lightPanel && compact ? 'text-slate-500' : 'text-white/45',
          )}
        >
      ...
      <div
        className={cn(
          compact
            ? 'flex w-full max-w-full flex-wrap items-center justify-center gap-2'
        ...
        {hasActiveFilters && (
          <button
            ...
            className={cn(
              ...
              compact ? 'text-[10px]' : 'text-xs sm:ml-auto',
            )}
          >
