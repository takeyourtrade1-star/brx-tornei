...
export function MatchCommentsPanel({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col overflow-hidden rounded-2xl border border-white/[0.08] bg-card2-end/90 shadow-xl shadow-card2-end/30 lg:flex-row">
