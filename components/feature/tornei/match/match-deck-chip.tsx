...
export function MatchDeckChip({ player, formatName }: MatchDeckChipProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      ...
      {open && (
        <div className="absolute left-0 top-full z-30 mt-1.5 w-56 rounded-2xl border border-white/10 bg-header-bg/95 p-3 shadow-2xl shadow-black/50 backdrop-blur-xl">
