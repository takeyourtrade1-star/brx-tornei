...
export function MatchDeckChip({ player, formatName }: MatchDeckChipProps) {
  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        className={cn(
          ...
          open
            ...
            : 'border-white/15 bg-card2-end/70 text-white/80 hover:border-white/30 hover:bg-footer-start/40 hover:text-white',
        )}
      >
      ...
      {open && (
        <div className="absolute left-0 top-full z-30 mt-1.5 w-56 rounded-2xl border border-white/10 bg-card2-end/95 p-3 shadow-2xl shadow-card2-end/40 backdrop-blur-xl">
