...
export function MatchCompactChat({
  ...
  return (
    <section className={'rounded-2xl border border-white/15 bg-card2-end/80 p-2 text-white shadow-2xl shadow-card2-end/30 backdrop-blur-xl' + (fullHeight ? ' flex h-full min-h-0 flex-col' : '')}>
