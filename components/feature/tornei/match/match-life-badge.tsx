...
export function MatchLifeBadge({
  ...
  return (
    <div
      ...
      className={cn(
        'relative flex min-w-0 flex-col items-center gap-1 overflow-hidden rounded-2xl border bg-header-bg/90 px-3.5 py-2 shadow-xl shadow-black/40 backdrop-blur-xl',
