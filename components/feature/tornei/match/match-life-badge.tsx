...
export function MatchLifeBadge({
  ...
  return (
    <div
      ...
      className={cn(
        'relative flex min-w-0 flex-col items-center gap-1 overflow-hidden rounded-2xl border bg-card2-end/85 px-3.5 py-2 shadow-xl shadow-card2-end/40 backdrop-blur-xl',
