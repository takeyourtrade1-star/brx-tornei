    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-center justify-between gap-4">
        ...
        <button
          ...
          disabled={isCreating}
          className="rounded-full bg-gradient-to-r from-[#FF7300] to-[#e0564d] px-4 py-2 text-xs font-bold uppercase tracking-wide text-white shadow-lg transition-transform active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
        >
          + Nuovo mazzo
        </button>
      </div>
