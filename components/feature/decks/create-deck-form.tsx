  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      <div className="flex flex-col gap-1.5">
        <label htmlFor="deck-name" className="text-xs font-bold uppercase tracking-wide text-white/55">
          Nome mazzo
        </label>
        <input
          id="deck-name"
          ...
          className="w-full rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/35 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20"
          autoFocus
        />
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        <div className="flex flex-col gap-1.5">
          <p
            ...
            className="text-xs font-bold uppercase tracking-wide text-white/55"
          >
            Formato
          </p>
          <FormatPillSelect
        ...
        <div className="flex flex-col gap-1.5">
          <p className="text-xs font-bold uppercase tracking-wide text-white/55">Tipologia</p>
          <StyledSelect
            value={archetypeId}
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button
          ...
          onClick={onCancel}
          disabled={isSubmitting}
          className="rounded-xl border border-white/15 bg-white/5 px-4 py-2.5 text-sm font-bold uppercase tracking-wide text-white/70 transition-colors hover:bg-white/10 hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
        >
          Annulla
        </button>
      </div>
