    ...
    <header className="header-gradient sticky top-0 z-50 w-full pb-6 font-sans text-white">
      <div className="mx-auto flex max-w-content items-center gap-3 px-4 py-2 sm:px-6">
        <Link
          ...
          className="flex items-center gap-1.5 transition-opacity hover:opacity-90 overflow-visible py-1"
        >
          <Image
            src={logoUrl}
            alt="Ebartex"
            width={120}
            height={52}
            className="h-[3.25rem] w-auto object-contain block align-middle"
            priority
            unoptimized
          />
